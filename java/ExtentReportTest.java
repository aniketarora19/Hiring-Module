...
public class ExtentReportTest{
 ...
 extent = new ExtentReports (System.getProperty("D:\\Profiles\\aniarora\\eclipse-workspace\\ExtentRepotTest") +"\\test-output\\ExtentReport.html", true);
 ...
 String destination = System.getProperty("D:\\Profiles\\aniarora\\eclipse-workspace\\ExtentRepotTest") + "\\FailedTestScreenshot\\"+screenshotName+dateName+".png";
 ...
 //To capture screenshot path and store the path of the screenshot in the string "screenshotPath"
                        ...
                        String screenshotPath = ExtentReportTest.getScreenhot(driver, result.getName());
